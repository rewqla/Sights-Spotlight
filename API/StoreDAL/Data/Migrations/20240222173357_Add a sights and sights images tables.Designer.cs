...
namespace StoreDAL.Data.Migrations
{
    ...
    [Migration("20240222173357_Add a sights and sights images tables")]
    partial class Addasightsandsightsimagestables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StoreDAL.Entities.Country", b =>
                {
                    ...
                    b.Property<string>("BackroundImgaeURL")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StoreDAL.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("StoreDAL.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("StoreDAL.Entities.User", null)
                        .WithMany()
