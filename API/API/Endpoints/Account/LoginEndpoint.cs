...
public static class LoginEndpoint
{
    ...
    {
        app.MapPost(AccountRoutes.Login, async (LoginRequest loginRequest, ILoggerFactory loggerFactory, UserManager<User> _userManager, ITokenService _tokenService) =>
        {
